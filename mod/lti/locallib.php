...
/**
 * Returns the Enabled Capabilities as Config Options for email,name and grade
 *
 * @param int $typeid   Basic LTI tool typeid
 *
 * @return array        Enabled Capabilites translated as Tool Configuration
 */
 ...
 * @return int id of the LTI Type, can be null if no type is found
 */
...
/**
 * Fetches Tool Proxy capabilities for an LTI instance and
 * translates them as Tool Configuration
 *
 * @param stdClass $instance
 * @return array Can be empty if no tool proxy is found
 */
